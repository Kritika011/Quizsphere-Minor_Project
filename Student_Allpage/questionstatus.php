                ...
                if (mysqli_num_rows($papers_result) > 0):
                    while ($paper = mysqli_fetch_assoc($papers_result)):
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Dynamic status based on the data -->
                                <span class="status-button pending">Pending</span>
                            </td>
                            <td>
                                <!-- Link to question details page -->
                                <a href="../Student_Allpage/questiondetails.php?paper_id=<?php echo $paper['paper_id']; ?>"
                                    class="links">click here</a>
                            </td>
                        </tr>
                    <?php endwhile;
                else: ?>
                    <tr>
                        <td colspan="3">No papers available for this subject.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
