...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2024 at 09:01 PM
...
CREATE TABLE `admindetails` (
  ...
  `verification_status` enum('0','1') DEFAULT '0'
...
(1, 16, '7056084925', '2004-02-29', 'male', 'tih', '../uploads/swapnadeep.jpeg', '0'),
(2, 17, '9052036852', '1960-02-14', 'male', 'tih', '../uploads/suman.jpg', '0');
...
(1, 79, 1, '', 'attended', 0),
(2, 79, 2, 'option1', 'attended', 0),
(3, 79, 3, '', 'attended', 0),
(4, 79, 4, '', 'attended', 0),
(5, 79, 5, '', 'unattended', 0),
(6, 79, 6, '', 'unattended', 0),
(7, 79, 7, 'option4', 'attended', 0),
(8, 79, 8, '', 'attended', 0),
(9, 79, 9, '', 'attended', 0),
(10, 79, 10, '', 'attended', 0),
(11, 79, 11, '', 'attended', 0),
...
(15, 79, 1, '', 'attended', 0),
(16, 79, 2, 'option1', 'attended', 0),
(17, 79, 3, '', 'attended', 0),
(18, 79, 4, '', 'attended', 0),
(19, 79, 5, '', 'unattended', 0),
(20, 79, 6, '', 'unattended', 0),
(21, 79, 7, '', 'unattended', 0),
(22, 79, 8, '', 'unattended', 0),
(23, 79, 9, '', 'unattended', 0),
(24, 79, 10, '', 'unattended', 0),
(25, 79, 11, '', 'unattended', 0),
(26, 79, 12, '', 'unattended', 0);
...
CREATE TABLE `exam_questions` (
  ...
  `correct_answer` enum('option1','option2','option3','option4') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 1, 'If the two inputs of a logic gate are 1 and 0, then the output of which logic gate is 1: ', 'AND gate', 'OR gate', 'NOR gate', '0100', ''),
(2, 1, 'Which digital gate performs the multiplication operation?', 'AND gate', 'NOR gate', 'OR gate', 'TASM', ''),
(3, 1, 'Which of the following is an INVALID state in an 8421 binary-coded decimal?', '1001', '1101', '1000', 'all I/P are high', ''),
(4, 1, 'Which of the following languages is used for programmable logic devices?', 'BASIC', 'PASCAL', 'PALASM', 'NAND gate', ''),
(5, 1, 'A three Input NOR gate gives high O/P when _______.', 'one I/P is high', 'one I/P is low', 'all I/P are low', 'level triggered', ''),
(6, 1, 'The digital equivalent of an electric series circuit is the:', 'AND gate', 'OR gate', 'NOR gate', '2 flipflops', ''),
(7, 1, 'Latches are _______ circuits.', 'edge triggered', 'pulse triggered', 'count triggered', 'AND with negative logic output', ''),
(8, 1, 'A decade counter requires', '4 flipflops', '3 flipflops', '10 flipflops', 'An op-code Fetch Cycle', ''),
(9, 1, 'A NAND circuit with positive logic will operates as', 'NOR with negative logic', 'AND with negative logic', 'OR with negative logic input', 'NAND Gate', ''),
(10, 1, 'In a 8085 microprocessor the first machine cycle of an instruction is', 'An I/O write cycle', 'A Memory Read Cycle', 'A Memory Write Cycle', 'NAND Gate', ''),
(11, 1, 'Which digital gate performs the multiplication operation?', 'AND Gate', 'NOR Gate', 'OR Gate', '', ''),
(12, 1, 'Which digital gate performs the multiplication operation?', 'AND Gate', 'NOR Gate', 'OR Gate', '', ''),
(13, 2, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(14, 2, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(15, 2, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(16, 2, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(17, 2, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(18, 2, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(19, 7, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(20, 8, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(21, 9, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(22, 9, 'First generation computers had which of the following?', 'Magnetic tapes', 'Transistors', 'ICs', 'Vaccum tubes & Magnetic drum', ''),
(23, 10, 'Which of these pins will allow to activate and deactivate a multiplexer?', 'Enable pin', 'Selection pin', 'Logic pin', 'Preset pin', ''),
(24, 10, 'Which of the following options are correct for a 4×1 multiplexer?', 'It has four 3 – input AND gates', 'It has four 2 – input AND gates', 'It has one 3 – input AND gate', ' It has one 3 – input AND gate', ''),
(25, 10, ' A priority encoder has four inputs I0, I1, I2, and I3 where I3 has the highest priority and I0 has the least priority. If I2 = 1, what will be the output?', '00', '01', '10', '11', ''),
(26, 10, 'Which of the following options represent the correct reduction of XYZ + XYZ ?', '0', ' YZ', 'X + X', '2YZ', ''),
(27, 10, 'What frequency division of the pulsed clock signal can be obtained by connecting 4 flip – flops in cascade?', '2', '4', '8', '16', ''),
(28, 11, 'How can you share a Power BI report with others?', 'Export to Excel', 'Publish to the web', 'Share via Power BI Service', 'All of the above', ''),
(29, 11, 'What are \"Custom Visuals\" in Power BI?', 'Default visuals provided by Power BI', ' Visuals created by third-party developers or the user', 'Visuals that cannot be customized', 'Pre-built templates for dashboards', '');
